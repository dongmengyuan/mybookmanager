...
public class showbook {
    ...
    public String showBook(@PathVariable(value = "bookInfoPkId") Integer bookInfoPkId,@PathVariable(value = "ugk_uid") Integer ugk_uid,Model model) {
        ...
        BookInfoPO bookInfoPO = bookInfoService.getBookByPk_id(bookInfoPkId);
        ...
        //获取书籍上传者的名字（id-->name)
        Map<BookInfoPO, String> BookInfo = BookUserMapUtil.getOnePageBookInfo(bookInfoPO, userService);
